...
import { PhoneIcon, EnvelopeIcon, ShieldCheckIcon, CodeBracketIcon, CheckBadgeIcon } from '@heroicons/react/24/outline';
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-4 flex justify-center md:justify-start">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-primary-dark hover:text-[#F47F24] transition-colors group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <CheckBadgeIcon className="h-5 w-5 group-hover:text-[#F47F24]" />
                <span className="text-sm font-mono">Credly</span>
              </motion.a>
            </div>
          </div>
