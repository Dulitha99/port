...
import { ShieldCheckIcon, CodeBracketIcon, LockClosedIcon, CheckBadgeIcon } from '@heroicons/react/24/outline';
          ...
          <div className="text-center">
            ...
            >
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-terminal-green hover:text-[#F47F24] transition-colors duration-300 group"
                whileHover={{ scale: 1.2 }}
                title="Credly"
              >
